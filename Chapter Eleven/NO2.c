...
void Analyze_hand(bool *straight, bool *flush, bool *four, bool *three_color_same, bool *full_house, short *pairs);
...
void Show_result(void)
{
	...
	short pairs;
	Analyze_hand(&straight,&flush,&four,&three_color_same,&full_house,&pairs);
	/*
